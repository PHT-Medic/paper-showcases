...
def init(mdlParams_):
    print('Using effb6_fk_st3_equaldist.py')
    mdlParams = {}
    ...
    ind_file = 's_3indices.pkl'  # Indices station specific
    ...
    for i in range(len(mdlParams['trainIndCV'])):
        ...
        print(
            "Train class distribution fold {}: {}".format(0,
                                                          np.sum(mdlParams['labels_array'][mdlParams['trainIndCV'][i]],
                                                                 axis=0)))
    print("Val")
    for i in range(len(mdlParams['valIndCV'])):
        print(mdlParams['valIndCV'][i].shape)
        print("Val class distribution fold {}: {}".format(i, np.sum(mdlParams['labels_array'][mdlParams['valIndCV'][i]],
                                                                    axis=0)))
