...
def init(mdlParams_):
    print('Using effb6_central_multigpu.py')
    mdlParams = {}
    ...
    ### Training Parameters ###
    # Batch size
    mdlParams['batchSize'] = 50#*len(mdlParams['numGPUs'])
    ...
    path1 = mdlParams['dataDir'] + '/labels/' # TODO it always loads the file in /mnt/vdb/data/isic/2019/labels/official/*.csv
    # TODO in train move labels_og.csv to another dir and use write new labels file!!!
    ...
    ### Define Indices ###
    ind_file = 'indices_isic2019_og.pkl'  # Original Indices # TODO update for other executions
    # ind_file = 'all_indices.pkl'
    with open(mdlParams['saveDir'] + ind_file,'rb') as f:
